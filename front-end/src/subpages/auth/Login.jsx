...
function InputRowPassword({ title, value, onChange }) {
    ...
    <div className="modal_input_row">
        <span>{title}</span>
        <input className="modal_input" type="password" onChange={(e)=>onChange(e.target.value)}></input>
    </div>);
}
        ...
        <div className="modal_overlay">
            <div className="modal_container">
                ...
                <div className="modal_input_table">
                    <InputRow title="Username" value={username} onChange={setUsername}></InputRow>
                    <InputRowPassword title="Password" value={password} onChange={setPassword}></InputRowPassword>
                </div>
                {
                    (error != null) && 
                    <p>{error}</p>
                ...
                <div className="modal_buttons">
                    ...
                    <button className="modal_button" onClick={() => LogInRequest()}> Accept</button>
                </div>
            </div>
        </div>
    );
