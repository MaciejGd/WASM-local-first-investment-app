...
test("AssetEntry removeNotMatchingAssets", () => {
  const asset = new AssetsEntry("LPP.WA");
  asset._data = [
    new AssetData(1, 3, 4),
    new AssetData(3, 4, 5),
  ...
  expect(asset._data).toEqual([new AssetData(1, 3, 4), new AssetData(3, 4, 5)]);
});

test("AssetsEntry selectData, entry not folded, set to true", () => {
  const asset = new AssetsEntry("LPP.WA");
...
test("AssetsEntry selectData, entry not folded, set to false", () => {
  const asset = new AssetsEntry("LPP.WA");
  const data1 = new AssetData(1, 3, 4);
  const data2 = new AssetData(3, 4, 5);
  const data3 = new AssetData(5, 6, 1);
...
test("AssetsEntry selectData, entry folded, set to true", () => {
  const asset = new AssetsEntry("LPP.WA");
  const data1 = new AssetData(1, 3, 4);
  const data2 = new AssetData(3, 4, 5);
  const data3 = new AssetData(5, 6, 1);
...
test("AssetsEntry deleteData, entry not folded, selected one entry", () => {
  const asset = new AssetsEntry("LPP.WA");
  const data1 = new AssetData(1, 3, 4);
  const data2 = new AssetData(3, 4, 5);
  const data3 = new AssetData(5, 6, 1);
...
test("AssetsEntry deleteData, entry folded, selected avg data", () => {
  const asset = new AssetsEntry("LPP.WA");
  asset.folded = true;
...
test("AssetsMap empty initialization", () => {
...
test("AssetsMap initialization from another AssetsMap", () => {
...
test("AssetsMap createFromDB assets array is undefined", () => {
  const asset_map = AssetsMap.createFromDB(undefined);
  expect(asset_map).toEqual(new AssetsMap());
});

test("AssetsMap createFromDB assets array is empty", () => {
...
test("AssetsMap fetchAssetsPrice", async () => {
...
test("AssetsMap updateFromDB assets empty", () => {
  const assets = new AssetsMap();
...
test("AssetsMap updateFromDB, removing unused old entries", () => {
  const assets_arr = [
    { ticker: "LPP.WA", ulid: 1, price: 12, quantity: 3 },
    { ticker: "ZAB.WA", ulid: 2, price: 10, quantity: 4 },
    { ticker: "TEST.WA", ulid: 3, price: 9, quantity: 1 },
...
test("AssetsMap updateFromDB current assets empty", () => {
  const assets_arr = [
    { ticker: "LPP.WA", ulid: 1, price: 12, quantity: 3 },
    { ticker: "ZAB.WA", ulid: 2, price: 10, quantity: 4 },
    { ticker: "TEST.WA", ulid: 3, price: 9, quantity: 1 },
...
test("AssetsMap updateFromDB, removing old values, preserving entry", () => {
  const assets_arr = [
    { ticker: "LPP.WA", ulid: 1, price: 12, quantity: 3 },
    { ticker: "ZAB.WA", ulid: 2, price: 10, quantity: 4 },
    { ticker: "TEST.WA", ulid: 3, price: 9, quantity: 1 },
