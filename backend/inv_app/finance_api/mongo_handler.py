...
class MongoHandler:
    ...
    def get_db(self, db_name: str):
        try:
            ...
            raise MongoDBException(f"Failed to get db: {db_name}") from e
    ...
    def get_collection(self, db, col_name: str):
        ...
        try:
            ...
            raise MongoDBException(f"Collection: {col_name}") from e
    ...
    def find_one(self, db_name, col_name, filter):
        ...
        try:
            ...
            raise MongoDBException("Failed to obtain one record from MongoDB") from e
    ...
    def get_all_docs(self, db_name, col_name):
        try:
            ...
            raise MongoDBException("Failed to get all docs from collection") from e
